    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-dropdown-link :href="route('pembelian_item.index')">
                                        {{ __('Pembelian Item') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('vendor.index')">
                                        {{ __('Vendor') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-slot>
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-dropdown-link :href="route('penjualan_item.index')">
                                        {{ __('Penjualan Item') }}
                                    </x-dropdown-link>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('stok.index')">
                                        {{ __('Stok') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('barang.index')">
                                        {{ __('Barang') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('warna.index')">
                                        {{ __('Warna') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-slot>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-100 hover:border-gray-300 dark:hover:border-gray-700 focus:outline-none focus:text-gray-700 dark:focus:text-gray-100 focus:border-gray-300 dark:focus:border-gray-700 transition duration-150 ease-in-out">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (auth()->check() && auth()->user()->usertype === 'admin')
                ...
                <x-responsive-nav-link :href="route('pembelian.index')" :active="request()->routeIs('pembelian.index')">
                    {{ __('Pembelian') }}
                </x-responsive-nav-link>
